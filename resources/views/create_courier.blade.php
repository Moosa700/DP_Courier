...
<body>
  ...
  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" style="background-color: #EB9B14; color:white" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base" >
            ...
            @if(auth()->user() !== null)
            <li class="nav-item px-2"><a class="nav-link" style="color: white;" href="{{route('logout')}}">Logout</a></li>
            @else
            <li class="nav-item px-2"><a class="nav-link" style="color: white;" href="{{route('user.login.form')}}">Login</a></li>
            @endif
    ...
    <section>
      ...
      <div class="container">
        <div class="row justify-content-center" id="ship">
          <div class="col-md-6 col-lg-5 col-xl-4"><img src="{{asset('user/assets/img/illustrations/callback.png')}}" alt="..." />
          ...
          <div class="col-md-6 col-lg-5 col-xl-4">
            <h1>Make Courier</h1>
            <br>
            <form method="post" action="{{route('user.courier.create')}}" class="row">
              <div class="mb-3">
                @csrf
                <input type="hidden" value="{{auth()->user()->id}}" name="user_id">
                <label class="form-label visually-hidden" for="inputName"> Sender Name </label>
                <input class="form-control form-quriar-control" id="inputName" name="sender_name" type="text" placeholder="Sender Name " />
              </div>
                           
               <div class="mb-3">
                <label class="form-label visually-hidden" for="inputPhone">sender_phone</label>
                <input class="form-control form-quriar-control" id="inputName" name="sender_phone" type="number" placeholder="Sender phone" />
              </div>   
              <div class="mb-3">
                <label class="form-label visually-hidden" for="inputAddress">Sender Address</label>
                <input class="form-control form-quriar-control" id="inputAddress" name="sender_address" type="text" placeholder="Sender Address" />
                </div>
                <div class="mb-3">
                <label class="form-label visually-hidden" for="inputEmail">Sender email</label>
                <input class="form-control form-quriar-control" id="inputEmail" name="sender_email" type="email" placeholder="Sender email" />
                </div>
                <div class="mb-3">
                <label class="form-label visually-hidden" for="inputName">Reciever Name</label>
                <input class="form-control form-quriar-control" id="inputName" name="reciver_name" type="text" placeholder="Reciever Name" />
                </div>             
                <div class="mb-3">
                <label class="form-label visually-hidden" for="inputName">Reciever phone</label>
                <input class="form-control form-quriar-control" id="inputName" name="reciver_phone" type="number" placeholder="Reciever phone" />
                </div>             
               <div class="mb-3">
                <label class="form-label visually-hidden" for="inputName">Reciever Address</label>
                <input class="form-control form-quriar-control" id="inputName" name="reciver_address" type="text" placeholder="Reciever Address" />
                    </div>        
                    <div class="mb-3">
                <label class="form-label visually-hidden" for="inputName">Reciever Email</label>
                <input class="form-control form-quriar-control" id="inputName" name="reciver_email" type="email" placeholder="Reciever Email" />
              </div>              
              <div class="mb-3">
              
              <select name="courier_type" id="" class="form-control form-quriar-control" >
               ...
               <div class="mb-3">
                <label class="form-label visually-hidden" for="inputName">Courier Weight</label>
                <input type="number" class="form-control  form-quriar-control" id="inputName" name="courier_weight" placeholder="Enter Weight" name="courier_weight">

              </div>
              <div class="mb-3">
                            <button type="submit" style="background-color: #F95C19; color:white; border-color:#F95C19; border-radius:5px">Submit</button>
